## Rolling GJR-GARCH (Student-t, df=10) — refit every hour; 60 one-step forecasts per refit
...
refit_blockwise_stride <- function(train_data, test_data,
  ...
  # Standardized-t (unit variance) quantile
...
readr::write_csv(all_summaries, "gjr_df10_summaries.csv")
readr::write_csv(all_details,   "gjr_df10_details.csv")

cat("Saved: gjr_df10_summaries.csv and gjr_df10_details.csv\n")
